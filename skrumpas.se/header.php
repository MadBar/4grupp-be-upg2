        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item my">
              <a class="nav-link my" href="index.php">Hem</a>
            </li>
            <li class="nav-item my">
              <a class="nav-link" href="om-oss.php">Om oss</a>
            </li>
            <li class="nav-item my">
              <a class="nav-link" href="samarbetspartners.php">Samarbetspartners</a>
            </li>
            <li class="nav-item my">
              <a class="nav-link" href="kontakt.php">Kontakta oss</a>
            </li>
          </ul>
        </div>
      </div>
